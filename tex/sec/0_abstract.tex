...
Our experiments demonstrate that the proposed pipeline consistently outperforms standard 4-bit quantization baselines, achieving up to 2.3\% accuracy improvement on the AIME benchmark while maintaining the memory efficiency of quantized deployment.
\end{abstract}

...
\paragraph{What is novel about the combination?}
The novelty is in treating \emph{quantized deployment} as a first-class constraint throughout the adaptation pipeline.
PiSSA provides a structured low-rank parameterization, SpinQuant-style orthogonal mixing reduces the quantization residual of the base/residual weights, and GaLore-style projection constrains optimization dynamics.
Together, these components approximate a joint constrained objective over (i) low-rank updates and (ii) rotation-aware quantized residual weights, which is not addressed by applying any single component in isolation.
